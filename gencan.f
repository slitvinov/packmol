c  
c  Written by Ernesto G. Birgin, 2009-2011.
c  Copyright (c) 2009-2011, Jose Mario Martinez,
c  Ernesto G. Birgin.
c  
...
c  
c
c Subroutine pgencan: This is only a interface to set some
c                    parameters that we do not change in packmol.
c
     ...
     +                gcnt,cgcnt,inform,wi,wd,delmin)
      if( inform.ne.7 .and.
     +   (iprint1.gt.0 .or. iprint2.gt.0) ) write(*,*)
